module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      user.bookings.end_during(start_time, end_time),
      user.bookings.start_during(start_time, end_time),
      user.bookings.happening_during(start_time, end_time),
      user.bookings.enveloping(start_time, end_time),
      user.bookings.identical(start_time, end_time)
    ].flatten
